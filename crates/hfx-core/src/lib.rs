...
pub use coordinator::{
    CompletedTransaction, DispatchResult, SubmissionResult, TransactionCoordinator,
...
pub use ports::{
    ...
    TransportFailureFacts, TransportReceipt, TransportReconciliation, TransportTerminal, WallClock,
};
...
pub use restoration::{
    ...
    RestorePlanResult, StableCommitOutcome, StableIntentCapture,
};
