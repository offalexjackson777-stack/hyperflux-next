...
def render_repository_state(root: Path) -> RepositoryStatePage:
  ...
  <header class="state-header"><div><h1>Repository State</h1><p class="lede">Generated release boundaries, migration decisions, verification budgets, and performance limits from the repository's canonical ledgers.</p></div><span class="state-lock">Publication locked</span></header>
